...
_ALARM = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='gov.usgs.volcanoes.alarm.Alarm.name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='type', full_name='gov.usgs.volcanoes.alarm.Alarm.type', index=1,
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='message', full_name='gov.usgs.volcanoes.alarm.Alarm.message', index=4,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='attachment', full_name='gov.usgs.volcanoes.alarm.Alarm.attachment', index=5,
